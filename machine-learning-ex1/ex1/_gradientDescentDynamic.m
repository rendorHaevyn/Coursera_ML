function [theta, J_history] = _gradientDescentDynamic(X, y, theta, alpha, num_iters, m)
%GRADIENTDESCENTMULTI Performs gradient descent to learn theta
%   theta = GRADIENTDESCENTMULTI(x, y, theta, alpha, num_iters, m) updates theta by
%   taking num_iters gradient steps with learning rate alpha acoss m training examples
...
for iter = 1:num_iters
    ...
    J_history(iter) = _computeCostDynamic(X, y, theta, m);
